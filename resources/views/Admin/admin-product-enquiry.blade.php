                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="card col-12">
                            <div class="card-body">
                                <h4 class="card-title">All Product Inquiries</h4>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $enquiry->product_code }}</td>
                                                <td>{{ $enquiry->price }}</td>
                                                <td>{{ $enquiry->main_sub_category }}</td>
                                                <td>{{ $enquiry->colors }}</td>
                                                <td>{{ $enquiry->sizes }}</td>
                                                <td>{{ $enquiry->units }}</td>
                                                <td>{{ $enquiry->customer_name }}</td>
                                                <td>{{ $enquiry->customer_email }}</td>
                                                <td>{{ $enquiry->customer_mobile }}</td>
                                                <td>{{ $enquiry->customer_address }}</td>
                                                <td>{{ $enquiry->detail_enquiry }}</td>
                                                <td>{{ $enquiry->enquiry_date }}</td>
                                                <td>
                                                    <a href="tel:{{ $enquiry->customer_mobile }}" class="btn btn-warning btn-sm">Call</a>
                                                </td>
                                                <td>
                                                    <a href="mailto:{{ $enquiry->customer_email }}" class="btn btn-success btn-sm">Mail</a>
                                                </td>
                                                <td>
                                                    <form action="{{ route('admin.product-enquiry.delete', $enquiry->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this enquiry?');">
                                                        @csrf
