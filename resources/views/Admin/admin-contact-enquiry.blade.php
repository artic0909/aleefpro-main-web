                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="card col-12">
                            <div class="card-body">
                                <h4 class="card-title">All Contact Us Inquiries</h4>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="tel:" class="btn btn-warning btn-sm" disabled>Call</a> {{-- No phone number in DB --}}
                                                </td>
                                                <td>
                                                    <a href="mailto:{{ $enquiry->email }}" class="btn btn-success btn-sm">Mail</a>
                                                </td>
                                                <td>
                                                    <form action="{{ route('admin.contact-enquiry.delete', $enquiry->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                                        @csrf
                                                        @method('DELETE')
