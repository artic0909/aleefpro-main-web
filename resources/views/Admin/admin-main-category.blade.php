            ...
            <div class="main-panel">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><button data-bs-toggle="modal" data-bs-target="#scrollEditModal{{ $maincategory->id }}" class="btn btn-success">Edit</button></td>
                                                <td><button data-bs-toggle="modal" data-bs-target="#scrollDeleteModal{{ $maincategory->id }}" class="btn btn-danger">Delete</button></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                ...
                <div class="modal fade" id="scrollAddModal" tabindex="-1" aria-labelledby="scrollAddModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{route('admin.main-category.store')}}" method="POST" class="modal-content" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-header">
                                <h5 class="modal-title" id="scrollAddModalLabel">Add Main Category</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div>
                                    <label for="main_category_name" class="form-label">Main Category Name<span class="text-danger">*</span></label>
                                    <input type="text" name="main_category_name" id="main_category_name" class="form-control" placeholder="Enter Main Category Name" required>
                                </div>
                            </div>
                ...
                <!-- Edit Modal -->
                @foreach($maincategories as $maincategory)
                <div class="modal fade" id="scrollEditModal{{ $maincategory->id }}" tabindex="-1" aria-labelledby="scrollEditModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{route('admin.main-category.edit', $maincategory->id)}}" method="POST" class="modal-content" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-header">
                                <h5 class="modal-title" id="scrollEditModalLabel{{ $maincategory->id }}">Edit Main Category</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div>
                ...
                <!-- Delete Modal -->
                @foreach($maincategories as $maincategory)
                <div class="modal fade" id="scrollDeleteModal{{ $maincategory->id }}" tabindex="-1" aria-labelledby="scrollDeleteModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{route('admin.main-category.delete', $maincategory->id)}}" method="POST" class="modal-content" enctype="multipart/form-data">
                            @csrf

                            <div class="modal-body">
                                <div>
                                    <h2 class="text-danger">You want to this Category?</h2>
                                    <p>{{ $maincategory->main_category_name }}</p>
