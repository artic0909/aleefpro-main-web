            ...
            <div class="main-panel">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><button data-bs-toggle="modal" data-bs-target="#scrollDescriptionModal{{ $faq->id }}" class="btn btn-warning">FAQ</button></td>
                                                <td><button data-bs-toggle="modal" data-bs-target="#scrollEditModal{{ $faq->id }}" class="btn btn-success">Edit</button></td>
                                                <td><button data-bs-toggle="modal" data-bs-target="#scrollDeleteModal{{ $faq->id }}" class="btn btn-danger">Delete</button></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                ...
                <div class="modal fade" id="scrollAddModal" tabindex="-1" aria-labelledby="scrollAddModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{route('admin.faq.store')}}" method="POST" class="modal-content" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-header">
                                <h5 class="modal-title" id="scrollAddModalLabel">Add FAQ</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div>
                                    ...
                                    <textarea name="answer" id="answer" class="form-control" required rows="5"></textarea>
                                </div>
                ...
                <!-- Edit Modal -->
                @foreach($faqs as $faq)
                <div class="modal fade" id="scrollEditModal{{ $faq->id }}" tabindex="-1" aria-labelledby="scrollEditModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{route('admin.faq.update', $faq->id)}}" method="POST" class="modal-content" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="modal-header">
                                <h5 class="modal-title" id="scrollEditModalLabel{{ $faq->id }}">Edit Sub Category</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                ...
                                <div>
                                    <label for="question" class="form-label">Question<span class="text-danger">*</span></label>
                                    <textarea name="question" id="question" class="form-control" required rows="5">{{ $faq->question }}</textarea>
                                </div>

                                <div>
                                    <label for="answer" class="form-label">Answer<span class="text-danger">*</span></label>
                                    <textarea name="answer" id="answer" class="form-control" required rows="5">{{ $faq->answer }}</textarea>
                                </div>
                ...
                <!-- Delete Modal -->
                @foreach($faqs as $faq)
                <div class="modal fade" id="scrollDeleteModal{{ $faq->id }}" tabindex="-1" aria-labelledby="scrollDeleteModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{route('admin.faq.delete', $faq->id)}}" method="POST" class="modal-content" enctype="multipart/form-data">
                            @csrf
                            @method('DELETE')
                            <div class="modal-body">
                                <div>
                                    <h2 class="text-danger">You want to this FAQ's delete?</h2>
                ...
                <!-- FAQ Modal -->
                @foreach($faqs as $faq)
                <div class="modal fade" id="scrollDescriptionModal{{ $faq->id }}" tabindex="-1" aria-labelledby="scrollDescriptionModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
