            ...
            <div class="main-panel">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="{{ asset('storage/' . $partner->image) }}" class="img-fluid" alt=""></td>

                                                <td><button data-bs-toggle="modal" data-bs-target="#scrollEditModal{{ $partner->id }}" class="btn btn-success">Edit</button></td>
                                                <td><button data-bs-toggle="modal" data-bs-target="#scrollDeleteModal{{ $partner->id }}" class="btn btn-danger">Delete</button></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                ...
                <div class="modal fade" id="scrollAddModal" tabindex="-1" aria-labelledby="scrollAddModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{route('admin.partner.store')}}" method="POST" class="modal-content" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-header">
                                <h5 class="modal-title" id="scrollAddModalLabel">Add Partner</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div>
                                    <label for="main_category_name" class="form-label">Partner's Logo<span class="text-danger">*</span></label>
                ...
                <!-- Edit Modal -->
                @foreach($partners as $partner)
                <div class="modal fade" id="scrollEditModal{{ $partner->id }}" tabindex="-1" aria-labelledby="scrollEditModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{route('admin.partner.update', $partner->id)}}" method="POST" class="modal-content" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="modal-header">
                                <h5 class="modal-title" id="scrollEditModalLabel{{ $partner->id }}">Edit Partner</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                ...
                <!-- Delete Modal -->
                @foreach($partners as $partner)
                <div class="modal fade" id="scrollDeleteModal{{ $partner->id }}" tabindex="-1" aria-labelledby="scrollDeleteModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{route('admin.partner.delete', $partner->id)}}" method="POST" class="modal-content" enctype="multipart/form-data">
                            @csrf
                            @method('DELETE')
                            <div class="modal-body">
                                <div>
                                    <h2 class="text-danger">You want to this Partner?</h2>
