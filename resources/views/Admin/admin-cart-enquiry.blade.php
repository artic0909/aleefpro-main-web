                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="card col-12">
                            <div class="card-body">
                                <h4 class="card-title">All Cart Inquiries</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            @foreach($cartEnquiries as $index => $cartEnquiry)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                <td>{{ $cartEnquiry->customer->name ?? '-' }}</td>
                                                <td>{{ $cartEnquiry->customer->email ?? '-' }}</td>
                                                <td>{{ $cartEnquiry->customer->mobile ?? '-' }}</td>

                                                <td>
                                                    @php
                                                    $enquiryItems = json_decode($cartEnquiry->enquiry_data, true);
                                                    @endphp
                                                    @if($enquiryItems)
                                                    <ul>
                                                ...
                                                <td>
                                                    <a href="tel:{{ $cartEnquiry->customer->mobile ?? '' }}" class="btn btn-warning">Call</a>
                                                </td>
                                                <td>
                                                    <a href="mailto:{{ $cartEnquiry->customer->email ?? '' }}" class="btn btn-success">Mail</a>
                                                </td>
                                                <td>
                                                    <form action="{{ route('admin.cart-enquiry.delete', $cartEnquiry->id) }}" method="POST">
                                                        @csrf
