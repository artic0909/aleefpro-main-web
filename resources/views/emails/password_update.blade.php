...
<head>
    <meta charset="UTF-8">
    <title>Password Updated - Aleef Pro</title>
</head>
            ...
            <tr>
                <td style="padding: 30px; font-family: Arial, sans-serif;">
                    ...
                    <div style="margin: 30px 0; text-align: center;">
                        <a href="{{ url('/contact') }}" style="background-color: #003366; color: #ffffff; padding: 12px 24px; text-decoration: none; display: inline-block; font-size: 16px; border-radius: 4px;">
                            Go to Website
                        </a>
                    </div>
                    ...
                    <p style="font-size: 14px; color: #999;">
                        ...
                        <a href="mailto:info@aleefpro.com" style="color: #6666ff;">info@aleefpro.com</a>
                    </p>
                </td>
            </tr>
