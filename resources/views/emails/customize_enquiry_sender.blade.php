...
<head>
    <meta charset="UTF-8">
    <title>Customization Enquiry - Aleef Pro</title>
</head>
            ...
            <tr>
                <td align="center" style="padding: 20px;">
                    <table width="600" style="background:white;border-radius:8px;padding:20px;">
                        <tr>
                            <td align="center">
                                <h2 style="color:#007bff;">New Customize Enquiry Received!</h2>
                        ...
                        <tr>
                            <td>
                                ...
                                <p><strong>Additional Enquiry:</strong> {{ $data['detail_enquiry'] ?? 'N/A' }}</p>
