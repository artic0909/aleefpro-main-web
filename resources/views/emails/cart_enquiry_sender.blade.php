        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 700px; margin: auto; background-color: #ffffff;">
            ...
            <tr>
                <td style="padding: 30px; font-family: Arial, sans-serif;">
                    <h2 style="color: #003366; margin-top: 0;">New Cart Enquiry Received</h2>
                    <p style="font-size: 16px; color: #333;">Customer Name: <strong>{{ $data['customer_name'] }}</strong></p>
                    <p style="font-size: 16px; color: #333;">Customer Email: <strong>{{ $data['customer_email'] }}</strong></p>
